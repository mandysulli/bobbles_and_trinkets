#!/bin/bash
#$ -o sra_illumina.$JOB_ID.out
#$ -e sra_illumina.$JOB_ID.err
#$ -N SRA_pull_illumina
#$ -pe smp 4
#$ -l h_rt=12:00:00
#$ -l h_vmem=12G
...
WORKDIR="/scicomp/groups-pure/OID/NCIRD/ID-OD/VSDB/BIA/MHS/large_flu_test_data/large_flu_wgs_illumina"
SRA_DIR="$WORKDIR/sra_illumina_pull"
...
# Define the samples to download
SAMPLES=(
    SRR7646310
)
...
for SAMPLE in "${SAMPLES[@]}"; do
    ...
    fasterq-dump --split-files "$SRA_FILE" -O "$FASTQ_DIR"
